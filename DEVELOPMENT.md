...
**ผลกับเคลมจริง 6 ใบ — แปลงได้หมด 0 ด่าน:** 059072 `ถอยชนคู่กรณี`→ชนคู่กรณีเสียหาย ·
147939 `คู่กรณีเฉี่ยวชน`→ถูกคู่กรณีชน · 058298/159949 `เฉี่ยว/เบียดคู่กรณี`→ชนคู่กรณีเสียหาย ·
158841/158857 ไม่มีคู่กรณี→เคลมแห้ง

**⚠️ ที่จงใจไม่แตะ (รอ user ตัดสิน):** เคลมที่**ไม่มีคู่กรณี**ยังได้ `เคลมแห้ง`
เสมอตามพฤติกรรมเดิมที่ใช้จริงมานาน — แต่ตารางจะบอกว่า 158841 `ชนวัสดุ/สิ่งของ`
ควรเป็น `เฉี่ยวชนวัสดุ` และเคส `รถหาย`/`น้ำท่วม` ก็ไม่ใช่ `เคลมแห้ง`
ถ้าจะเปลี่ยนให้เอาตารางมาก่อน แล้วค่อย fallback `เคลมแห้ง` — เป็นการเปลี่ยน
พฤติกรรมที่ verify ไว้แล้ว จึงต้องให้ user สั่ง
