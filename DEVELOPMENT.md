...
6. **บอทเดาได้เฉพาะเรื่องที่ "พิสูจน์คำตอบได้แล้ว"** (กติกา user 2026-08-05)
   - ของที่ทำไปแล้วและมีคำตอบยืนยัน — **เก็บไว้ ไม่ต้องรื้อ** เช่น คำนำหน้าผู้ขับขี่
     (ไล่จากเพศ/อายุ ตรวจกับข้อมูลจริงแล้ว §6.6) และตารางลักษณะความเสียหาย
     (แปลงจาก master จริง 58/58 §6.7)
   - **ของใหม่ที่ยังพิสูจน์ไม่ได้ → อย่าเดา ให้เตือนแล้วปล่อยคนเลือกบน EMCS**
     เช่น ประเภทเคลม 'งานนัดหมาย' ที่ ISURVEY ไม่มีตัวเลือก (§6.3.5) — บอทติ๊ก
     ตามต้นทาง + ย้อมเหลืองไว้ ไม่เปลี่ยนค่าให้เอง
   - ⚠️ **เตือนต้องหายาก** ถ้าเตือน 10+ ข้อต่องาน คนจะเลิกอ่านทั้งกอง เกณฑ์ตัดสิน:
