...
บนหน้าจอถึงจะผ่าน ตัววินิจฉัย (`_diagnose_save_click`) ทำงานถูก: บอกว่า *"validForm()
ผ่านตอนเรียกเอง แต่กดปุ่มแล้วไม่มีอะไรเกิดขึ้น — ปัญหาอยู่ที่การกดปุ่ม ไม่ใช่ข้อมูลไม่ครบ"*
พอคนกดให้แล้วสั่งไปต่อ ที่เหลือไหลจนจบ (คู่กรณี→ความเสียหาย→ค่าใช้จ่าย) ไม่ติดอะไรอีก
