...
| ฝั่งกรอก EMCS **เคลมสด/คู่กรณี** | 🟢 คู่กรณี + **ผู้บาดเจ็บ (Tab5) + ทรัพย์สิน (Tab6)** ครบ verify 2026-06-18 (ดู §4): อ่าน Tab4 (combo) + กรอกฟิลด์/ประเภทรถ/ประกัน/กรมธรรม์/ความเสียหาย + `fill_injuries`/`fill_assets` บันทึกผ่านรอบแรก; เหลือ ยี่ห้อ/มีประกันภัยที่ เลือกเอง + อัปรูป tp_person/tp_prop |
...
- **ผู้บาดเจ็บ:** เมนู `wuMenuPage1_imbInjure_Person` → `ddlInj_Count` (1-5) →
  ...
  - `ddlPerson_Type` value: **01**=ผู้ขับขี่รถประกัน / **03**=ผู้โดยสารรถประกัน /
    **05**=บุคคลภายนอกรถ → map XML PERSON_TYPE (DV→01/PV→03/ON→05) = `PERSON_TYPE_MAP`
