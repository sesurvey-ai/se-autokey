...
def read_tab1_summary(driver, data: ClaimData):
    ...
    # กติกา user 07/09/69 (ยึดปุ่ม "นำเข้า ISURVEY" เป็นแม่แบบ) — 13/08/69 เคยลง review_comment
    # ยกเลิกแล้ว · ความเห็นของผู้ตรวจสอบปล่อยว่าง (ย้าย ไม่ก๊อปซ้ำ 2 ช่อง) · ต้องตรงกับ isurvey_api.py
