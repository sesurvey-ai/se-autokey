...
def parse_args():
    ...
    if not (args.claim or args.claims or args.claims_file or args.data_json
            or args.sesurvey_case or args.emcs_images or args.emcs_sync_status or args.station):
...
_DMG_LVL_RANK = {'L': 'A', 'M': 'B', 'H': 'C', 'X': 'D',  # ระดับ ต่ำ/กลาง/สูง/สูงมาก → rank A-D (rdoDam_Lavel)
                 ...
                 # คำไทยจาก ISURVEY บางงาน (เคส #343 15/09/69 "แผลเบา") — ตัวแปลง/backend แปลงให้แล้ว แต่รับไว้เผื่อข้อมูลเก่า
                 'แผลเบา': 'A', 'แผลกลาง': 'B', 'แผลหนัก': 'C', 'เปลี่ยน': 'D', 'เบา': 'A', 'กลาง': 'B', 'หนัก': 'C'}
